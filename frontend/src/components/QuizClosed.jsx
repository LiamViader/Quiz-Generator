    ...
    return(
        <Slide in={true}>
            <Box
                ...
                py='0.5rem'
                pl='0.6rem'
                sx={{boxShadow:'0px 2px 5px gray', borderRadius: '1.1rem', backgroundColor: quiz.quiz.solved ? '#9aaab1' : '#051923', color: 'white', flex: '1 1 auto', marginRight: '2%', marginTop:'2%', maxWidth: quiz.loading ? '5rem' : '12rem', maxHeight:'1.5rem', overflow: 'hidden', minWidth:'3rem'}}
            >
                {quiz.loading ? 
