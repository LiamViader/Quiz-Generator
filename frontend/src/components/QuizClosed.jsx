...
import { Slide, Box, CircularProgress, Typography, Menu, MenuItem, IconButton, ButtonBase} from '@mui/material';
                    ...
                    <div style={{display: 'flex', overflow: 'hidden', width:'100%'}}>
                        <ButtonBase onClick={handleClickQuiz} sx={{display:'flex', flexGrow:'1',overflow: 'hidden'}}>
                            <div style={{ display:'flex', overflow: 'hidden', marginTop:'auto', marginBottom:'auto'}}>
                                <QuizIcon sx={{color: quiz.solved ? 'white' : '#7fffd4',  }} />
                            </div>
                            <div style={{ flex: '2', display: 'flex', alignItems:'center', overflow: 'hidden', marginLeft:'0.3rem'}}>
                                <Typography sx={{flexGrow:'1', fontWeight: 'bold', fontSize:'0.8rem', overflow:'hidden', textOverflow:'ellipsis', whiteSpace: 'nowrap'}}> {quiz.name}</Typography>
                            </div>
                        </ButtonBase>
                        ...
                        <div style={{display:'flex', justifyContent: 'flex-end', marginLeft:'auto', alignItems:'left', overflow: 'hidden'}}>
                            ...
                            <Menu
                                ...
                                onClose={handleClose}
                            >
                                <MenuItem onClick={() => handlePrivacy()}>{quiz.privacy=="private"? "Make Public" : "Make Private"}</MenuItem>
